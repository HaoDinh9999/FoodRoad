          ...
          <Grid item xs={12} lg={9}>
            <Grid container spacing={3}>
              <Grid item xs={12} lg={6}>
                <CardSales
                  imgSrc="https://www.saigonfoodtour.com/uploads/products/5/taste_of_the_night_4.jpg"
                  price={62}
              ...
              <Grid item xs={12} lg={6}>
                <CardSales
                  imgSrc="https://www.saigonfoodtour.com/uploads/products/6/vegan_tour_3.jpg"
                  price={49}
                  title="Vegan Tour"
