...
import CardItem from "./CardItem"
import { FormControlLabel, Grid, FormGroup, FormControl, Container } from "@mui/material"
	...
	return (
		<div className="container">
			<Grid container spacing={95}>
				...
				<Grid item>
					<Box sx={{ display: 'flex', alignItems: 'flex-end', pb: 3, pt: 0 }}>
			...
			<Collapse in={isChecked} sx={{ pb: 2 }}>
				<Box sx={{ display: 'flex', pt: 0 }}>
					<FormControl sx={{ m: 3 }} component="fieldset" variant="standard">
						<Typography variant="subtitle2"> Advanced Filter</Typography>
