...
export default function ExpandableContent() {
  ...
  if (isMobile)
    return (
      <div className="submit-form-mobile">
        <form name="submit form" className="submit-form-mobile">
          ...
          <label className="fraudCheck required">
            <div className="inner">
              <input
                ...
                name="noFraud"
                value="1"
                className="verify-ckbx"
              />
              <div className="terms">
                I vertify that this review is based on my own experience and is
  ...
  return (
    <div className="submit-form">
      <form name="submit form" className="submit-form">
        <label className="reviewTitle required">
          <div className="review-form">Title of your review</div>
          <input
            className="formInput"
        ...
        <label className="fraudCheck required">
          <div className="inner">
            ...
            />
            <div className="terms">
              I vertify that this review is based on my own experience and is my
              ...
              establishment to write this review. I understand that Tripadvisor
