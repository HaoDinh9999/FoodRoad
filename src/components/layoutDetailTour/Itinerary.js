        ...
        <Grid item sm={12} xs={12} md={4}>
          ...
          <Box display="flex">
            ...
            <Box>
              ...
              <Box
                width="90%"
                display={show === "none" && text === "1" ? "block" : "none"}
              >
          ...
          <Box display="flex">
            ...
            <Box>
              ...
              <Box
                width="90%"
                display={show2 === "none" && text === "2" ? "block" : "none"}
              >
                <Box display="flex" alignItems="center">
                  <IconButton
                    aria-label="delete"
          ...
          <Box display="flex">
            ...
            <Box>
              ...
              <Box
                width="90%"
                display={show3 === "none" && text === "3" ? "block" : "none"}
              >
                <Box display="flex" alignItems="center">
                  <IconButton
                    aria-label="delete"
                ...
                >
                  ...
                  worry, our guide takes you around Saigon and explore "Chung
                  cư" - a Vietnamese old apartment which was built very long
                  time ago. We will sit down to taste coffee in the hidden
                  coffee shop and learn how to make a glass of Vietnamese coffee
                  with a Vietnamese filter, not a machine. It is so good and
                  that is why it has its place in everyone's bucket list when
                  coming to Vietnam.{" "}
                </Typography>
                <Button
                  sx={{
