...
const  ListInfo =() => {
    return(
      <Box marginTop="50px">
        ...
        <Grid container >
            <Grid item sm={8}>
            <Typography  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light',marginTop:"15px"}}> 
            If there’s one absolute must-do in Vietnam, it’s a food tour: The knowledge gained on a good culinary tour sets you up for your entire vacation. On this Ho Chi Minh City evening tour, cruise the city by night on a motorbike (with designated driver), get an intimate look at local life, and sample street food classics straight from the vendors.
            </Typography>   
            </Grid>
            <Grid item sm={1}></Grid>
            ...
            <Box height="10px"></Box>
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li> Cruise Ho Chi Minh City by night on a motorbike with designated driver/guide
            </Typography>  
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li>Sample authentic Vietnamese street food straight from the vendors
            </Typography>  
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li>Learn about local life—and dishes!—from your personal guide
            </Typography>  
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li>Taste Vietnamese coffee, desserts, spring rolls, “pizza,” and so much more
              </Typography>  
            </Grid>
            <Grid item sm={12} marginTop="15px">
            <Typography  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'medium',}}> 
            ...
            <Box height="10px"></Box>
            <Typography   variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            Your driver/guide collects you from your central Ho Chi Minh City hotel and explain how to ride safely on the back of a motorbike. Don your helmet, and you’re off through brightly lit boulevards, back alleys, and busy streets. Along the way, sample enough street food to add up to dinner.            </Typography>  
            <Box height="15px"></Box>
        ...
        <Grid item sm={8} marginTop="20px">
            ...
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li>Children under 6 years old must be accompanied by an adult

            </Typography>  
            <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
            <li></li>Passengers weighing over 150kg, please consult with operator before booking


            </Typography> <Typography display="flex"  variant="h6" component="h2"  sx={{fontSize:"18px",fontWeight: 'light'}}> 
